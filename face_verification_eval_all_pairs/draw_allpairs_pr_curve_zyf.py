...
def calc_roc(similarity_mat, gt_mat, threshs=None, save_dir='./'):
    if threshs is None:
    ...
    pos_all_with_diag = gt_mat.sum()
    neg_all_x2 = mat_shape[0] * mat_shape[1] - pos_all_with_diag
    pos_all_x2 = pos_all_with_diag - mat_shape[0]

    print "pos_all_with_diag: ", pos_all_with_diag
    print "pos_all_x2: ", pos_all_x2
    print "neg_all_x2: ", neg_all_x2

    print "pos_all_effective: ", pos_all_x2 * 0.5
    print "neg_all_effective: ", neg_all_x2 * 0.5
